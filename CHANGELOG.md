...
* A2Aプロトコルのステートフル差分送信(Stateful Deltas)とスキーマ補完(Schema Bridging)を実装 ([03deafa](https://github.com/yohi/opencode-geminicli-a2a/commit/03deafa1f0be178d3c8d7050d0c92dd6dbf6af5f))
...
* **gemini:** Geminiの自動承認機能の有効化とテスト追加 ([ebf3335](https://github.com/yohi/opencode-geminicli-a2a/commit/ebf33358f437b835949c1682433ada04e877a0da))
...
* サーバー管理の堅牢化、外部設定ファイルの監視、および可観測性の向上を実装 ([9a57b13](https://github.com/yohi/opencode-geminicli-a2a/commit/9a57b134567ad2a5654c20efd934e2a667889d31))
...
* **a2a-client:** ネットワークリクエストと設定のデフォルトマッピングを改善 ([e64a393](https://github.com/yohi/opencode-geminicli-a2a/commit/e64a393c3b8dc16dd5e7256fc932c865fcd36b2f))
...
* A2Aプロトコルでのマルチターン時のコンテキスト重複送信を修正 ([4ddf7bf](https://github.com/yohi/opencode-geminicli-a2a/commit/4ddf7bfb8d4c159df7b24edd0f78cd2e092de784))
...
* **mapper:** intercept and rewrite tool hallucinations to safe bash calls to prevent doom_loop ([fb8b9ff](https://github.com/yohi/opencode-geminicli-a2a/commit/fb8b9ff9a8ca8984f7c2888aa6818d814cc3a67a))
...
* **provider:** OpenCodeでのツール実行が中断される問題を修正 (AI SDK V3互換性の向上) ([4e45b84](https://github.com/yohi/opencode-geminicli-a2a/commit/4e45b84a9966721824ca98525e1d23cb96559cfe))
...
* **provider:** revert tool-call stream parts to tool-input-start/delta/end for OpenCode compatibility ([b51dcd7](https://github.com/yohi/opencode-geminicli-a2a/commit/b51dcd7659e4f917767b62c2faf40a5970a465f4))
